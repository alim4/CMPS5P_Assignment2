...
def main():
    global unittest
    # Set to 1 to enable auto-input of test values
    unittest = 0
    ...
    stddev = calculateStandardDev(stddev_list) * 1000
    ...
    mean_period_return = (total_period_return / number_of_trials) * 10000
    ...
    print("We ran {0} trials, each at {1:.4g}% return ({2:.4g}% std dev) for {3} periods. "
          .format(number_of_trials, avg_return*100, stddev_return*100, number_of_periods))
